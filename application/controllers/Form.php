...
class Form extends CI_Controller {
	...
	{
		$data['query']=$this->data_model->list_case();
		$data['query1']=$this->data_model->list_loc();
		$data['query2']=$this->data_model->list_name();
		$this->load->view('home/header',$data);
		$this->load->view('home/form_view', array('error' => ' ' ),$data);
...
/* 	echo '<pre>';
	...
	public function adding()
	{
		...
		$this->form_validation->set_rules('case_loc', 'สถานที่', 'trim|required|min_length[1]',
                array('required' => 'กรุณากรอกข้อมูล %s.','min_length' => 'กรุณากรอกข้อมูลขั้นต่ำ 1 ตัว'));
		$this->form_validation->set_rules('p_status', 'สถานภาพ', 'trim|required|min_length[1]',
                array('required' => 'กรุณากรอกข้อมูล %s.','min_length' => 'กรุณากรอกข้อมูลขั้นต่ำ 1 ตัว'));
