<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <a href="<?= site_url('jobs/bystatus/'.$qstatus1->case_status);?>
            ?status=รอดำเนินการ" class="btn btn-primary">  งานใหม่ <span class="badge"><?= $qstatus1->totalstatus1;?></span></a>

            <a href="<?= site_url('jobs/bystatus/'.$qstatus2->case_status);?>
            ?status=กำลังดำเนินการ" class="btn btn-info"> กำลังทำ <span class="badge"><?= $qstatus2->totalstatus2;?></span></a>

            <a href="<?= site_url('jobs/bystatus/'.$qstatus3->case_status);?>
            ?status=เสร็จสิ้น" class="btn btn-success"> ปิดงาน <span class="badge"><?= $qstatus3->totalstatus3;?></span></a>

            <a href="<?= site_url('jobs/bystatus/'.$qstatus4->case_status);?>
            ?status=ยกเลิก" class="btn btn-danger"> ยกเลิก <span class="badge"><?= $qstatus4->totalstatus4;?></span></a>

            <a class="btn btn-default" href="<?=  site_url('jobs'); ?>" role="button"><i class="fa fa-fw fa-refresh"></i> Refresh Data</a>
            <br><br>
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                if ($rs->p_status == 1) {
                                                    echo "สถานภาพ : อาจารย์";
                                                } elseif ($rs->p_status == 2) {
                                                    echo "สถานภาพ : นิสิต";
                                                }?>
                                            </td>
                                            <td>
